...
@Component({
  selector: 'app-admin-fish-page',
  templateUrl: './admin-fish-page.component.html',
  styleUrls: ['./admin-fish-page.component.scss']
})
export class AdminFishPageComponent implements OnInit {
